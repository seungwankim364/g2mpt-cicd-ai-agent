...
| DOC-37 | [Clone to Run Step by Step](docs/20-implementation/32-clone-to-run-step-by-step.md) | fresh clone 이후 local test, Lambda package, Terraform plan/apply, webhook, Slack, dashboard, destroy 실행 순서 |
